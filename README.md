...
<a href="url"><img src="https://github.com/fariba-k/autoencoder-nmf-initialization/blob/main/images/loss_drop_legend.png" align="middle" alt="autoencoder architecture" width="300"></a>
|                          | Epochs = 10              |  Epochs = 50 |
:-------------------------:|:------------------------:|:-------------------------:
